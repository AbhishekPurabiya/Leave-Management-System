						...
						<c:forEach items="${projectDetails}" var="employee">
                    			<tr>
                    				...
                    				<td>
	                    				...
	                    				style="display: flex; flex-direction: row; column-gap: 1cm;">
	                    				
	               
											<div>
												<a href="/lms/hr/deleteProject?id=<c:out value='${employee.id}'/>" onclick="return confirm('Are you sure you want to delete?');">
											...
											<div>
	                    						<a href="/lms/hr/editProject?id=<c:out value='${employee.id}'/>">
