        ...
        <%@ include file="/views/dashboard.jsp" %>
            ...
            <!-- right content -->
                ...
                <div>
                    ...
                    <br>
                    <hr>
                    <form action="/lms/hr/addEmployee" method="post" onsubmit="return validate()">
                        <div>
                            <br>
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="EmployeeId"
                                            placeholder="Employee Id" name="empId" value="<c:out value='${newEmpId}'/>" readonly >
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <select class="form-select pb-4" aria-label="Default select example" id="selectRole" name="empRole" required>
                                ...
                                <div class="col">
                                    ...
                                    <p class="text-danger ">${contactError}</p>
                                </div>
