...
<body class="dashboard dashboard_2">
    <div class="full_container">
        <div class="inner_container">
            ...
            <div id="content">
                <!-- dashboard inner -->
				<p class="text-center text-dark" style="font-size: 30px;">Manage Senior Manager Leave Request</p>
                    <br>
                    <hr>
				<table class="table table-success table-striped">
					...
					<tbody>
						<c:forEach items="${ManagerLeaveDetails}" var="leaveList">
                    			<tr>
                    				...
                    				<td>
		            				<a href="/lms/hr/editActionManager?id=<c:out value='${leaveList.id}'/>">
