                    			...
                    			<tr>
                    				...
                    				<td>
	                    				<div class="action-button">
	                    					<div>
	                    						<a href="/lms/hr/edit?empId=<c:out value='${employee.empId}'/>">
											...
											<div>
												<a href="/lms/hr/delete?empId=<c:out value='${employee.empId}'/>" onclick="return confirm('Are you sure you want to delete?');">
											...
											<div>
												<a href="/lms/hr/addProject?empId=<c:out value='${employee.empId}'/>">
